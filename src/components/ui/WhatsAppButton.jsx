  ...
  return (
    ...
    >
      ...
      <div className="relative w-16 h-16 flex items-center justify-center">
        ...
        {/* Core circle — noir, not green */}
        <div className="relative w-12 h-12 rounded-full bg-[var(--color-ink)] flex items-center justify-center shadow-[0_10px_40px_-10px_rgba(10,10,10,0.5)] group-hover:bg-[var(--color-accent)] transition-colors duration-500">
          {/* Pulsing dot */}
          <span
            ref={dotRef}
